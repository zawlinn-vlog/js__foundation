...
console.log(Number('Jonas'), typeof NaN); // NaN is number type.
...
else if (age == '18') console.log(`You Just Become an Adult :D (loosly)`);
else console.log(`Something Else!`);

const hasDriverLicense = true;
const hasGoodSight = true;
...
const getDriverLicense =
  ageSarah >= 18 ? 'Sarah can Drive' : 'Sarah cannot Drive';

console.log(`Sarah ${ageSarah >= 18 ? 'can' : 'cannot'} Drive.`);
